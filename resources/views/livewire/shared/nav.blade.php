...
<nav class="bg-white shadow mb-4">
        ...
        <div class="relative flex h-16 justify-between">
          ...
          -->
                    <svg class="block h-6 w-6"
                        ...
                        stroke="currentColor"
                        aria-hidden="true"
                        class="{{ $showNavMenu ? 'hidden' : 'block' }}">
                    ...
                    <div>
                        <button type="button"
                            ...
                            <img class="h-8 w-8 rounded-full"
                                src="{{ auth()->user()->photo ?? gravatar(auth()->user()->email) }}"
                                alt="">
                        </button>
                    </div>
    ...
    <div class="sm:hidden {{ $showNavMenu ? 'block' : 'hidden' }}"
        id="mobile-menu" 
        >
        <div class="space-y-1 pb-4 pt-2">
            ...
            <a href="{{ route('contacts.index') }}"
                class="block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700">Contacts</a>
            <a href="{{ route('companies.index') }}"
                class="block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700">Companies</a>
        </div>
    </div>
</nav>
@script
