            ...
            <div class="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
                <div class="ml-4 mt-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <a href="{{ route('contacts.show', $c) }}"><h3 class="text-base font-semibold leading-6 text-gray-900">{{ $c->first_name }} {{ $c->middle_name ? substr($c->middle_name, 0, 1) . '.' : '' }} {{ $c->last_name }}</h3></a>
                            <p class="text-sm text-gray-500">
                                @if($c->title) {{ $c->title }} @endif @if($c->company) at {{ $c->company }} @endif
                            </p>
                        </div>
                    </div>
                </div>
                ...
                @if($c->phone)
                    <a type="button" href="tel:{{ $c->phone }}"
                ...
                @endif
                @if($c->email)
                    <a type="button" href="mailto:{{ $c->email }}"
