        ...
        <div class="tab-content translations-content-item en visible"
            ...
            <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
                ...
                created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/"
                    target="_blank"
                    rel="noreferrer">Free Privacy Policy Generator</a>.</p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                        Agreement) refers to EPIC LABS INC, 1850 Braeburn Circle Atlanta GA 30316.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Real People CRM, accessible from <a
                            href="https://realpeoplecrm.com"
                            rel="external nofollow noopener noreferrer"
                            target="_blank">https://realpeoplecrm.com</a></p>
                </li>
                <li>
            ...
            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or
                ...
                browser. Learn more about cookies on the <a
                    ...
                    target="_blank"
                    rel="noreferrer">Free Privacy Policy website</a> article.</p>
